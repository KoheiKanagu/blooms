...
class HighlightStyleFeaturesList extends StatelessWidget {
  const HighlightStyleFeaturesList({super.key});

  @override
  Widget build(BuildContext context) {
    final featureTextStyle = CupertinoTheme.of(
      context,
      ...
      children: [
        Padding(
          ...
          child: Text(
            ...
            style: featureTextStyle.copyWith(fontWeight: FontWeight.bold),
          ),
        ),
        const Gap(8),
        const _Features(),
...
class _SimpleText extends StatelessWidget {
  const _SimpleText({required this.text, required this.icon});
