...
void main() {
  ...
  group('nextSaturdayInstance', () {
    ...
    test('次の週の土曜日の時間が求められること（指定時刻を過ぎている場合）', () async {
      const time = TimeOfDay(hour: 10, minute: 0);
    ...
    test('次の週の土曜日の時間が求められること（土曜日以外で指定時刻を過ぎている場合）', () async {
      const time = TimeOfDay(hour: 10, minute: 0);
